...
// Facebook API Token - Replace with environment variable in production
    ...
    try {
        switch (name) {
            ...
            case 'facebook_schedule_post':
                ...
                const scheduleResult = await fbClient.schedulePost(String(args.pageId), String(args.message), scheduledTime, args.photoUrl ? String(args.photoUrl) : undefined);
                return {
                    content: [
                        {
                            type: 'text',
